...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            Alert(title: Text(scoreTitle), message: scoreTitle == "Correct!" ? Text("Your score is \(score)") : Text("Wrong! That's the flag of \(countries[pickedCountry])"), dismissButton: .default(Text("Continue")) {
                self.askQuestion()
            })
        }
    }
